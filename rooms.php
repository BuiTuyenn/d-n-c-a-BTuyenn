...
<head>
    ...
    <title>Phòng - BuiTuyenn Hotel</title>
    <style>
...
<div class="content">
    ...
    <div class="search-box">
        ...
        <div class="checkbox-group">
            ...
            <div class="checkbox-item">
                <input type="checkbox" id="washing" name="facilities" value="washing">
                <label for="washing">Máy giặt</label>
            </div>
            <div class="checkbox-item">
            ...
            <div class="checkbox-item">
                <input type="checkbox" id="radiator" name="facilities" value="radiator">
                <label for="radiator">Máy sưởi</label>
            </div>
            <div class="checkbox-item">
                <input type="checkbox" id="tv" name="facilities" value="tv">
                <label for="tv">TV, Wifi</label>
            </div>
        </div>
        <label for="adults">Số Khách</label>
        <input type="number" id="adults" name="adults" placeholder="Người Lớn" min="1" value="1">
        <label for="children">Số Trẻ Em</label>
        <input type="number" id="children" name="children" placeholder="Trẻ Em" min="0" value="0">
