...
<head>
    ...
    <title>Giới Thiệu - BuiTuyenn Hotel</title>
...
<header style="background-color: #fff; border-bottom: 2px solid #ddd; padding: 10px 0;">
    <div style="display: flex; justify-content: space-between; align-items: center; max-width: 1200px; margin: 0 auto; padding: 0 20px;">
        ...
        <nav style="flex: 2; text-align: center;">
            ...
            <a href="manager.php" style="margin: 0 15px; text-decoration: none; color: #207335; font-size: 18px;">Quản Lý</a>
...
<section class="content">
    <div class="text-section">
        <h2 style="color: #207335; font-size: 32px; font-family: 'Be VietNam Pro', sans-serif;">Giới thiệu về Tuyền Hotel</h2>
        <p style="font-family: 'Be VietNam Pro', sans-serif; text-align: justify; font-size: 18px; line-height: 1.6;">Tuyền Hotel tự hào là một trong những điểm đến đầu hàng Việt Nam để cho những ai tìm kiếm trải nghiệm lưu trú tuyệt vời tại khu vực. Với vị trí đắc địa, khách sạn mang đến không gian yên bình và sang trọng, phù hợp cho cả du khách nghỉ dưỡng và doanh nhân. Chúng tôi cam kết cung cấp dịch vụ chất lượng cao với đội ngũ nhân viên chuyên nghiệp, tận tâm và luôn sẵn sàng đáp ứng mọi nhu cầu của khách hàng. Các phòng nghỉ được thiết kế hiện đại và tiện nghi, mang đến cảm giác thoải mái như ở nhà. Ngoài ra, Tuyền Hotel còn có nhiều đa dạng các tiện nghi như: Spa, TV, Điều Hòa,... và dịch vụ chăm sóc khách hàng 24/7, giúp mỗi kỳ nghỉ của bạn trở nên hoàn Tuyền hơn. Hãy đến với Tuyền Hotel để trải nghiệm dịch vụ tuyệt vời và những kỷ niệm đáng nhớ!</p>
    </div>
    <div class="image-section">
        <img src="./images/introducee.jpg" alt="Tuyền Hotel" style="width: 100%; height: auto; border-radius: 10px;">
    </div>
</section>
...
<section class="statistics">
    <div class="stat">
        <img src="./images/hotel-icon.png" alt="Phòng" class="stat-image">
        <div class="stat-number"><strong>+100</strong></div> <!-- Đã in đậm số liệu -->
        <p>Phòng</p>
    </div>
    <div class="stat">
        <img src="./images/customer-icon.png" alt="Khách hàng" class="stat-image">
        <div class="stat-number"><strong>+200</strong></div> <!-- Đã in đậm số liệu -->
        <p>Khách hàng</p>
    </div>
    <div class="stat">
        <img src="./images/rate-icon.png" alt="Đánh giá" class="stat-image">
        <div class="stat-number"><strong>+200</strong></div> <!-- Đã in đậm số liệu -->
        <p>Đánh giá</p>
    </div>
    <div class="stat">
        <img src="./images/member-icon.png" alt="Nhân viên" class="stat-image">
...
<section class="content">
    <div class="image-section" style="flex: 1;">
        <img src="" alt="Chủ Tịch" style="width: 100%; height: auto; border-radius: 10px;">
    </div>
    <div class="text-section" style="flex: 1; padding: 0 20px;">
        <h2 style="color: #207335; font-size: 32px; font-family: 'Be VietNam Pro', sans-serif;">Chủ tịch của Tuyền Hotel</h2>
        <p style="font-family: 'Be VietNam Pro', sans-serif; text-align: justify; font-size: 18px; line-height: 1.6;">
        Chủ tịch của Tuyền Hotel - ông Bùi Tuyền là một trong những nhà lãnh đạo đầu hàng trong ngành khách sạn tại Việt Nam.
         Với hơn 25 năm kinh nghiệm trong lĩnh vực quản lý khách sạn và dịch vụ khách hàng, ông đã góp phần quan trọng vào sự phát triển và thành công của Tuyền Hotel.
          Ông luôn đặt khách hàng làm trung tâm, cam kết mang lại những trải nghiệm tuyệt vời nhất cho du khách.
           Dưới sự dẫn dắt của ông, Tuyền Hotel đã nhận được nhiều giải thưởng danh giá và trở thành một trong những khách sạn được yêu thích nhất trong khu vực Đông Nam Á.
        </p>
    </div>
</section>
...
<section class="content">
    <div class="text-section" style="flex: 1; padding: 0 20px;">
        <h2 style="color: #207335; font-size: 32px; font-family: 'Be VietNam Pro', sans-serif;">Đội ngũ của Tuyền Hotel</h2>
        <p style="font-family: 'Be VietNam Pro', sans-serif; text-align: justify; font-size: 18px; line-height: 1.6;">
        Đội ngũ nhân viên tại Tuyền Hotel là một tập hợp những chuyên gia giàu kinh nghiệm, nhiệt huyết và luôn sẵn sàng phục vụ khách hàng. 
        ...
        Mỗi thành viên trong đội ngũ đều cam kết cung cấp dịch vụ tận tâm và chu đáo, đảm bảo rằng mỗi khách hàng đều cảm thấy thoải mái và hài lòng khi lưu trú tại Tuyền Hotel.
        Chúng tôi luôn nỗ lực không ngừng để nâng cao chất lượng dịch vụ và tạo ra những trải nghiệm đáng nhớ cho khách hàng.
        </p>
    </div>
    <div class="image-section" style="flex: 1;">
        <img src="system-run.png" alt="Đội ngũ Tuyền Hotel" style="width: 100%; height: auto; border-radius: 10px;">
    </div>
</section>
