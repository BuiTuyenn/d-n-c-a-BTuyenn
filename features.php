...
<head>
    ...
    <title>Tiện Nghi - BuiTuyenn Hotel</title>
</head>
...
<section style="max-width: 1200px; margin: 40px auto; text-align: center;">
    ...
    <div style="display: flex; justify-content: space-around; margin-bottom: 40px; gap: 30px;">
        ...
        <div style="width: 30%; border: 1px solid #ddd; padding: 20px; border-radius: 10px;">
            <img src="./images/dieu-hoa.png" alt="Điều Hòa" style="width: 60px; margin-bottom: 10px;">
            <h3 style="color: #207335; font-family: 'Be VietNam Pro', sans-serif;">Điều Hòa</h3>
            <p style="text-align: justify; line-height: 1.6; font-family: 'Be VietNam Pro', sans-serif;">Tại Hảo Hotel, mỗi phòng đều được trang bị hệ thống điều hòa 2 chiều hiện đại, giúp duy trì không gian thoải mái, vui vẻ và dễ chịu. Bạn có thể chỉnh nhiệt độ theo sở thích, phù hợp để đảm bảo có những trải nghiệm tuyệt vời xuyên suốt thời gian sử dụng dịch vụ.</p>
        </div>

        <!-- Máy Giặt -->
        <div style="width: 30%; border: 1px solid #ddd; padding: 20px; border-radius: 10px;">
            <img src="./images/may-giat.png" alt="Máy Giặt" style="width: 60px; margin-bottom: 10px;">
            <h3 style="color: #207335; font-family: 'Be VietNam Pro', sans-serif;">Máy Giặt</h3>
            <p style="text-align: justify; line-height: 1.6; font-family: 'Be VietNam Pro', sans-serif;">Tại Hảo Hotel, mỗi phòng đều được trang bị hệ thống máy giặt với công nghệ hiện đại, đa dạng các chức năng giặt giũ nhằm đảm bảo phù hợp với mọi loại vải hiện đang có ở trên thị trường. Đặc biệt, có hệ thống sấy khô giúp khách hàng không phải lo khi đang cần gấp quần áo.</p>
        </div>

        <!-- Bình Nóng Lạnh -->
        <div style="width: 30%; border: 1px solid #ddd; padding: 20px; border-radius: 10px;">
            <img src="./images/binh-nong-lanh.png" alt="Bình Nóng Lạnh" style="width: 60px; margin-bottom: 10px;">
            <h3 style="color: #207335; font-family: 'Be VietNam Pro', sans-serif;">Bình Nóng Lạnh</h3>
            <p style="text-align: justify; line-height: 1.6; font-family: 'Be VietNam Pro', sans-serif;">Tại Hảo Hotel, mỗi phòng đều được trang bị bình nóng lạnh tiện lợi, đảm bảo rằng bạn luôn có nước nóng hoặc lạnh vào bất cứ thời gian nào bạn cần. Điều này giúp bạn có những trải nghiệm thoải mái hơn trong suốt thời gian lưu trú.</p>
        </div>
    </div>
    ...
    <div style="display: flex; justify-content: space-around; gap: 30px;">
        <!-- Spa -->
        <div style="width: 30%; border: 1px solid #ddd; padding: 20px; border-radius: 10px;">
            <img src="./images/spa.png" alt="Spa" style="width: 60px; margin-bottom: 10px;">
            <h3 style="color: #207335; font-family: 'Be VietNam Pro', sans-serif;">Spa</h3>
            <p style="text-align: justify; line-height: 1.6; font-family: 'Be VietNam Pro', sans-serif;">Đến với Hảo Hotel, chúng tôi tự hào tiên phong trong việc cung cấp dịch vụ Spa thư giãn với các liệu pháp chăm sóc sắc đẹp chuyên nghiệp và lành mạnh. Hãy để chúng tôi mang đến cho bạn những phút giây thư giãn sau những thời gian làm việc quá căng thẳng.</p>
        </div>

        <!-- Máy Sưởi -->
        <div style="width: 30%; border: 1px solid #ddd; padding: 20px; border-radius: 10px;">
            <img src="./images/may-suoi.png" alt="Máy Sưởi" style="width: 60px; margin-bottom: 10px;">
            <h3 style="color: #207335; font-family: 'Be VietNam Pro', sans-serif;">Máy Sưởi</h3>
            <p style="text-align: justify; line-height: 1.6; font-family: 'Be VietNam Pro', sans-serif;">Để đảm bảo sự thoải mái tối đa trong những ngày đông lạnh giá mà bạn còn không có người yêu, mỗi phòng của chúng tôi đều được trang bị máy sưởi với công nghệ hiện đại. Bạn sẽ luôn cảm thấy ấm áp và dễ chịu như mùa xuân mặc cho thời tiết bên ngoài như thế nào.</p>
        </div>

        <!-- TV -->
        <div style="width: 30%; border: 1px solid #ddd; padding: 20px; border-radius: 10px;">
            <img src="./images/tv.png" alt="TV" style="width: 60px; margin-bottom: 10px;">
            <h3 style="color: #207335; font-family: 'Be VietNam Pro', sans-serif;">TV</h3>
            <p style="text-align: justify; line-height: 1.6; font-family: 'Be VietNam Pro', sans-serif;">Tại Hảo Hotel, mỗi phòng đều được trang bị TV màn hình cong với chất lượng sắc nét, âm thanh sống động. Ngoài ra, TV được tích hợp nhiều kênh truyền hình trong nước và quốc tế. Kèm với đó, TV đi kèm với các dịch vụ thông minh như Youtube, Netflix,... giúp khách hàng trải nghiệm đa dạng.</p>
        </div>
    </div>
</section>
